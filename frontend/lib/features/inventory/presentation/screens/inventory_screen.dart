  ...
  Future<void> _pickFileAndUpload() async {
    try {
      ...
      if (result != null && result.files.single.path != null) {
        ...
        // Cerrar el modal de Quick Actions antes de procesar
        ...
        actions: [
          TextButton(
            onPressed: () {
              ...
              Navigator.pop(context); // Cerrar modal padre también
            },
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              // El modal padre ya se cerró antes de mostrar este diálogo
              try {
                final response = await context
                    .read<InventoryProvider>()
