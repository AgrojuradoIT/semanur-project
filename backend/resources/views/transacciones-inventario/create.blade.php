    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h1 class="text-2xl font-bold mb-4">Crear Transacción de Inventario</h1>
                <form method="POST" action="{{ route('transacciones-inventario.store') }}">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="transaccion_tipo" id="transaccion_tipo" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                            ...
                            <option value="entrada" {{ old('transaccion_tipo') == 'entrada' ? 'selected' : '' }}>Entrada</option>
                            <option value="salida" {{ old('transaccion_tipo') == 'salida' ? 'selected' : '' }}>Salida</option>
                            <option value="ajuste" {{ old('transaccion_tipo') == 'ajuste' ? 'selected' : '' }}>Ajuste</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="transaccion_cantidad" id="transaccion_cantidad" value="{{ old('transaccion_cantidad') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" step="0.01" min="0.01" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="transaccion_motivo" id="transaccion_motivo" value="{{ old('transaccion_motivo') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="transaccion_referencia_type" id="transaccion_referencia_type" value="{{ old('transaccion_referencia_type') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="transaccion_referencia_id" id="transaccion_referencia_id" value="{{ old('transaccion_referencia_id') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="transaccion_notas" id="transaccion_notas" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('transaccion_notas') }}</textarea>
