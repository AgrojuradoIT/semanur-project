            ...
            <div class="p-6 text-gray-900">
                ...
                <form method="POST" action="{{ route('productos.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="producto_sku" id="producto_sku" value="{{ old('producto_sku') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        @error('producto_sku')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" name="producto_nombre" id="producto_nombre" value="{{ old('producto_nombre') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="producto_unidad_medida" id="producto_unidad_medida" value="{{ old('producto_unidad_medida') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="producto_stock_actual" id="producto_stock_actual" value="{{ old('producto_stock_actual', 0) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" step="0.01">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="producto_alerta_stock_minimo" id="producto_alerta_stock_minimo" value="{{ old('producto_alerta_stock_minimo', 0) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" step="0.01">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="producto_precio_costo" id="producto_precio_costo" value="{{ old('producto_precio_costo') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" step="0.01" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="producto_ubicacion" id="producto_ubicacion" value="{{ old('producto_ubicacion') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
