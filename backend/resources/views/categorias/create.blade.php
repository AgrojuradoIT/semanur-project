            ...
            <div class="p-6 text-gray-900">
                ...
                <form method="POST" action="{{ route('categorias.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="categoria_nombre" id="categoria_nombre" value="{{ old('categoria_nombre') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="categoria_tipo" id="categoria_tipo" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                            ...
                            <option value="repuesto" {{ old('categoria_tipo') == 'repuesto' ? 'selected' : '' }}>Repuesto</option>
                            <option value="servicio" {{ old('categoria_tipo') == 'servicio' ? 'selected' : '' }}>Servicio</option>
                            <option value="otro" {{ old('categoria_tipo') == 'otro' ? 'selected' : '' }}>Otro</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="categoria_descripcion" id="categoria_descripcion" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('categoria_descripcion') }}</textarea>
